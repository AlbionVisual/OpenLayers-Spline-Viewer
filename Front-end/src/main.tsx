...
function renderAll() {
    ...
    root.render(
        ...
        return <MapController key={x.map.get('id') || Math.random().toString(36).substring(2, 15)} map={x.map} backendUrl={x.backendUrl} />
        })
    )
}
...
let exampleLayer = createCurvesLayer(map, "http://localhost:8000/curves")
