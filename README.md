...
### 5. Оптимизация большого зума

Если достаточно отдалиться, то рано или поздно будут видны абсолютно все сплайны, а значит, что с бэкенда придут все-все сплайны, а смысловой нагрузки они нести вообще не будут. В решении нет никакой оптимизации по этому поводу, хотя есть идеи: придумать более общее отображение сплайнов или выбирать наиболее важные, которые будут отображаться преимущественно (как дороги); не отображать никакие сплайны при маленьком зуме (например меньше 8 единиц); оставить всё как есть (если мы будем строить эти кривые только для одного города, то их может не хватить, чтобы крашнуть какую-то из частей).
